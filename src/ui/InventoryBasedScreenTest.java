...
public class InventoryBasedScreenTest {
	...
	public void testDisplayOutput_1()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateDropScreen();
	...
	public void testDisplayOutput_2()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateEatScreen();
		AsciiPanel terminal = new AsciiPanel();
	...
	public void testDisplayOutput_3()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateEquipScreen();
		AsciiPanel terminal = new AsciiPanel();
	...
	public void testDisplayOutput_4()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateExamineScreen();
		AsciiPanel terminal = new AsciiPanel();
	...
	public void testRespondToUserInput_1()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateQuaffScreen();
	...
	public void testRespondToUserInput_2()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateReadScreen();
		KeyEvent key = new KeyEvent(new AppletMain(), 1, 1L, 1, 1);
	...
	public void testRespondToUserInput_3()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateReadScreen2();
		KeyEvent key = new KeyEvent(new AppletMain(), 1, 1L, 1, 1);
	...
	public void testRespondToUserInput_4()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateReadScreen3();
		KeyEvent key = new KeyEvent(new AppletMain(), 1, 1L, 1, 1);
	...
	public void testRespondToUserInput_5()
		throws Exception {
		InventoryBasedScreen fixture = InventoryBasedScreenFactory.createcreateThrowScreen();
		KeyEvent key = new KeyEvent(new AppletMain(), 1, 1L, 1, 1);
