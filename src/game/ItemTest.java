...
public class ItemTest {
	...
	public void testAddWrittenSpell_1()
		throws Exception {
		Item fixture = ItemFactory.createItem2();
		String name = "";
		int manaCost = 1;
		Effect effect = EffectFactory.createEffect2();
	...
	public void testAppearance_1()
		throws Exception {
		Item fixture = ItemFactory.createItem4();
	...
	public void testAttackValue_1()
		throws Exception {
		Item fixture = ItemFactory.createItem3();
	...
	public void testColor_1()
		...
		// add additional test code here
		assertNotNull(result);
		assertEquals("java.awt.Color[r=0,g=0,b=255]", result.toString());
	...
	public void testDefenseValue_1()
		throws Exception {
		Item fixture = ItemFactory.createItem();
